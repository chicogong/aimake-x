...
<head>
    ...
    <title>AI导航 - 找到最适合你的 AI 工具</title>
    
    <!-- SEO Meta Tags -->
    <meta name="description" content="AI导航帮你快速找到最适合的AI工具。支持视频剪辑、会议记录、合同审查、代码生成、AI绘画等50+款AI产品智能推荐。">
    <meta name="keywords" content="AI工具,人工智能,AI推荐,视频剪辑,会议记录,合同审查,代码生成,AI绘画,剪映,Kimi,通义听悟,ChatGPT">
    <meta name="author" content="AI导航">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="https://ai-nav.example.com/">
    
    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://ai-nav.example.com/">
    <meta property="og:title" content="AI导航 - 找到最适合你的 AI 工具">
    <meta property="og:description" content="AI导航帮你快速找到最适合的AI工具。支持视频剪辑、会议记录、合同审查、代码生成等50+款AI产品智能推荐。">
    <meta property="og:image" content="https://ai-nav.example.com/og-image.png">
    <meta property="og:locale" content="zh_CN">
    <meta property="og:site_name" content="AI导航">
    
    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:url" content="https://ai-nav.example.com/">
    <meta name="twitter:title" content="AI导航 - 找到最适合你的 AI 工具">
    <meta name="twitter:description" content="AI导航帮你快速找到最适合的AI工具。支持视频剪辑、会议记录、合同审查、代码生成等50+款AI产品智能推荐。">
    <meta name="twitter:image" content="https://ai-nav.example.com/og-image.png">
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "AI导航帮你快速找到最适合的AI工具，支持50+款AI产品智能推荐",
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .search-box:focus-within {
            ...
            box-shadow: 0 0 0 4px rgba(0, 102, 255, 0.1), var(--shadow-glow);
        }
...
<body>
    ...
    <section class="hero">
        <div class="container">
            ...
            <h1>找到最适合你的<br><span>AI 工具</span></h1>
            <p class="hero-subtitle">
                告诉我你想做什么，我帮你找到最合适的 AI 产品。<br>
                不再迷失在众多 AI 工具中，一键直达。
            </p>
            ...
            <div class="search-container">
                ...
                <div class="quick-tags">
                    <span class="quick-tag" data-query="视频剪辑加字幕">视频剪辑</span>
                    <span class="quick-tag" data-query="会议录音转文字">会议记录</span>
                    <span class="quick-tag" data-query="分析合同文档">合同审查</span>
                    <span class="quick-tag" data-query="写代码">代码生成</span>
                    <span class="quick-tag" data-query="处理Excel表格">Excel处理</span>
                    <span class="quick-tag" data-query="AI绘画生成图片">AI绘画</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        function renderResults(data) {
            ...
            document.getElementById('resultsQuery').textContent = '根据「' + data.query + '」为你推荐';
